...
class UpdateTimesRequest extends FormRequest
{
    ...
    {
        return [
            'nome' => 'required|max:50|unique:times,nome,'.$this->id.'|min:2',
            'pais' => 'required|max:100|min:2',
            'ano_fundacao' => 'required|max:2022|min:1800|integer'
        ];

        // ,nome,'.$this->id.': ao fazer o update, ele deixa cadastrar um registro com o mesmo nome, pois estamos alterando
    }
